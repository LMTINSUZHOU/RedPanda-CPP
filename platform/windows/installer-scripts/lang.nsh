...
LangString SectionAddToPathName 1033  "Add MinGW to system PATH"
LangString MessageSectionAddToPath 1033  "Add the MinGW compiler to the system PATH so it can be used as the system C/C++ compiler from the command line"
...
LangString SectionAddToPathName 2052  "将 MinGW 加入系统 PATH"
LangString MessageSectionAddToPath 2052  "将 MinGW 编译器加入系统 PATH，使其可在命令行中作为系统 C/C++ 编译器使用"
