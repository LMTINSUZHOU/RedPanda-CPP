...
{
    // Local copy prevents TOCTOU race when another thread clears indents
    // between isEmpty() and back() (fixes #695).
...
{
    return type==i2.type && lineSeq==i2.lineSeq && keyword == i2.keyword;
}
